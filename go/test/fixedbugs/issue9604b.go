...
var types = []_type{
	...
	{"int64", 64, true},
	{"uint64", 64, false},
	{"int", 8 * uint(unsafe.Sizeof(int(0))), true},
	{"uint", 8 * uint(unsafe.Sizeof(uint(0))), false},
	{"uintptr", 8 * uint(unsafe.Sizeof((*byte)(nil))), false},
}
...
var binops = []binop{
	...
	{"&^", func(x, y *big.Int) *big.Int { return new(big.Int).AndNot(x, y) }},
}
...
var unops = []unop{
	{"+", func(x *big.Int) *big.Int { return new(big.Int).Set(x) }},
	{"-", func(x *big.Int) *big.Int { return new(big.Int).Neg(x) }},
	{"^", func(x *big.Int) *big.Int { return new(big.Int).Not(x) }},
}
