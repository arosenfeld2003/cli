...
func NewManualCommitStrategy() Strategy { //nolint:ireturn // returns interface by design
...
func NewShadowStrategy() Strategy { //nolint:ireturn // returns interface by design
